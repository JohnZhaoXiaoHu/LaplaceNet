...
VALUES ('原因类别', 1096, 999, 'PpCauseType', 'production/PpCauseType', 0, 0, 'C', '0', '0', 'pp:causetype:list', 'icon1', 'system', GETDATE(), 'menu.PpCauseType');
...
VALUES ('zh-cn', 'menu.PpCauseType', '原因类别', GETDATE());
INSERT INTO sys_common_lang(lang_code, lang_key, lang_name, addtime) 
VALUES ('en', 'menu.PpCauseType', '原因类别', GETDATE());
INSERT INTO sys_common_lang(lang_code, lang_key, lang_name, addtime) 
VALUES ('ja', 'menu.PpCauseType', '原因类别', GETDATE());
