...
VALUES ('财务期间', 121, 999, lower('FicoPeriod'), 'financial/FicoPeriod', 0, 0, 'C', '0', '0', 'fico:period:list', 'icon1', 'system', GETDATE(), 'menu.FicoPeriod');
...
VALUES (163153521333121001,'zh-cn', 'menu.FicoPeriod', '财务期间', GETDATE());

INSERT INTO sys_common_lang(id,lang_code, lang_key, lang_name, addtime) 
VALUES (163153521333121002,'en', 'menu.FicoPeriod', '财务期间', GETDATE());

INSERT INTO sys_common_lang(id,lang_code, lang_key, lang_name, addtime) 
VALUES (163153521333121003,'ja', 'menu.FicoPeriod', '财务期间', GETDATE());