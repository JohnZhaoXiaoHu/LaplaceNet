...
VALUES ('部门消耗', 1094, 999, 'FicoDeptConsuming', 'financial/FicoDeptConsuming', 0, 0, 'C', '0', '0', 'fico:deptconsuming:list', 'icon1', 'system', GETDATE(), 'menu.FicoDeptConsuming');
...
VALUES ('zh-cn', 'menu.FicoDeptConsuming', '部门消耗', GETDATE());
INSERT INTO sys_common_lang(lang_code, lang_key, lang_name, addtime) 
VALUES ('en', 'menu.FicoDeptConsuming', '部门消耗', GETDATE());
INSERT INTO sys_common_lang(lang_code, lang_key, lang_name, addtime) 
VALUES ('ja', 'menu.FicoDeptConsuming', '部门消耗', GETDATE());
