...
VALUES ('销售凭证', 1095, 999, lower('SdSalesProof'), 'sales/SdSalesProof', 0, 0, 'C', '0', '0', 'sd:salesproof:list', 'icon1', 'system', GETDATE(), 'menu.SdSalesProof');
...
VALUES (1631535213331095001,'zh-cn', 'menu.SdSalesProof', '销售凭证', GETDATE());

INSERT INTO sys_common_lang(id,lang_code, lang_key, lang_name, addtime) 
VALUES (1631535213331095002,'en', 'menu.SdSalesProof', '销售凭证', GETDATE());

INSERT INTO sys_common_lang(id,lang_code, lang_key, lang_name, addtime) 
VALUES (1631535213331095003,'ja', 'menu.SdSalesProof', '销售凭证', GETDATE());