...
VALUES ('预算实际明细', 1094, 999, 'FicoBudgetactualCost', 'financial/FicoBudgetactualCost', 0, 0, 'C', '0', '0', 'fico:budgetactualcost:list', 'icon1', 'system', GETDATE(), 'menu.FicoBudgetactualCost');
...
VALUES ('zh-cn', 'menu.FicoBudgetactualCost', '预算实际明细', GETDATE());
INSERT INTO sys_common_lang(lang_code, lang_key, lang_name, addtime) 
VALUES ('en', 'menu.FicoBudgetactualCost', '预算实际明细', GETDATE());
INSERT INTO sys_common_lang(lang_code, lang_key, lang_name, addtime) 
VALUES ('ja', 'menu.FicoBudgetactualCost', '预算实际明细', GETDATE());
