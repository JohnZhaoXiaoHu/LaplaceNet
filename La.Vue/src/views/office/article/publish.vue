      ...
      <el-form :model="form" ref="formRef" label-width="100px" :rules="rules" @submit.prevent>
        ...
        <el-form-item label="文章分类" prop="categoryId">
          <el-cascader class="w100" :options="categoryOptions"
            :props="{ checkStrictly: true, value: 'categoryId', label: 'name', emitPath: false }" placeholder="请选择文章分类"
            clearable v-model="form.category_Id" />
        </el-form-item>
        ...
        <el-form-item label="文章标签">
          ...
          <el-input v-if="inputVisible" ref="inputRef" v-model="inputValue" class="w20"
