...
<template>
  <div>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" :disabled="single" v-hasPermi="['qm:checkaql:edit']" plain icon="edit"
          @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" :disabled="multiple" v-hasPermi="['qm:checkaql:delete']" plain icon="delete"
          @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange"
      ...
      <el-table-column prop="qcaqlGuid" label="Guid" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('qcaqlGuid')" />
      <el-table-column prop="qcaqlLevel" label="查检水平" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('qcaqlLevel')" />
      <el-table-column prop="qcaqlRange" label="批量范围" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('qcaqlRange')" />
      <el-table-column prop="qcaqlRangeMinmum" label="最小值" align="center"
        v-if="columns.showColumn('qcaqlRangeMinmum')" />
      <el-table-column prop="qcaqlRangeMaximum" label="最大值" align="center"
        v-if="columns.showColumn('qcaqlRangeMaximum')" />
      <el-table-column prop="qcaqlSamplesCode" label="样本码" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('qcaqlSamplesCode')" />
      ...
      <el-table-column :label="$t('btn.operate')" align="center" width="160">
        <template #default="scope">
          <el-button v-hasPermi="['qm:checkaql:edit']" type="success" icon="edit" :title="$t('btn.edit')"
            @click="handleUpdate(scope.row)"></el-button>
          <el-button v-hasPermi="['qm:checkaql:delete']" type="danger" icon="delete" :title="$t('btn.delete')"
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="24">
            <el-form-item label="Guid" prop="qcaqlGuid">
              <el-input v-model="form.qcaqlGuid" controls-position="right" :placeholder="$t('btn.enter')+'Guid'"
                disabled="true" :disabled="title==$t('btn.edit')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="查检水平" prop="qcaqlLevel">
              <el-input v-model="form.qcaqlLevel" :placeholder="$t('btn.enter')+'查检水平'"
          ...
          <el-col :lg="12">
            <el-form-item label="批量范围" prop="qcaqlRange">
              <el-input v-model="form.qcaqlRange" :placeholder="$t('btn.enter')+'批量范围'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="最小值" prop="qcaqlRangeMinmum">
              <el-input-number v-model.number="form.qcaqlRangeMinmum" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'最小值'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="最大值" prop="qcaqlRangeMaximum">
              <el-input-number v-model.number="form.qcaqlRangeMaximum" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'最大值'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="样本码" prop="qcaqlSamplesCode">
              <el-input v-model="form.qcaqlSamplesCode" :placeholder="$t('btn.enter')+'样本码'"
                :disabled="title==$t('btn.edit')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="抽样数" prop="qcaqlSamplesQty">
              <el-input-number v-model.number="form.qcaqlSamplesQty" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'抽样数'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="合格项" prop="qcaqlAcQty">
              <el-input-number v-model.number="form.qcaqlAcQty" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'合格项'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="不合格项" prop="qcaqlReQty">
              <el-input-number v-model.number="form.qcaqlReQty" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'不合格项'" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="isDeleted" prop="isDeleted">
              <el-input v-model="form.isDeleted" :placeholder="$t('btn.enter')+'isDeleted'" :disabled="true" />
            </el-form-item>
          </el-col>
...
<script setup name="qmcheckaql">
  // 引入 qmcheckaql操作方法
  import {
    listQmCheckAql, addQmCheckAql, delQmCheckAql, updateQmCheckAql, getQmCheckAql,
