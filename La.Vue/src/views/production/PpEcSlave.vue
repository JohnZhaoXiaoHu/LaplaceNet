        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="用量" prop="esOldUsageQty">
              <el-input-number clearable v-model.number="form.esOldUsageQty" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'用量'" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="用量" prop="esNewUsageQty">
              <el-input-number clearable v-model.number="form.esNewUsageQty" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'用量'" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="bom日期" prop="esBomDate">
              <el-date-picker clearable v-model="form.esBomDate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="旧品库存" prop="esOldCurrStock">
              <el-input-number clearable v-model.number="form.esOldCurrStock" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'旧品库存'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="新品库存" prop="esNewCurrStock">
              <el-input-number clearable v-model.number="form.esNewCurrStock" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'新品库存'" />
            </el-form-item>
          </el-col>
