  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      ...
      <el-form-item label="内容" prop="emEcContent">
        <el-input clearable v-model="queryParams.emEcContent" :placeholder="$t('btn.enter')+'内容'" />
      </el-form-item>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="损失金额" prop="emEcLossAmount">
              <el-input-number clearable v-model.number="form.emEcLossAmount" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'损失金额'" />
            </el-form-item>
          </el-col>
