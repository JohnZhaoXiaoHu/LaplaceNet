  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      ...
      <el-form-item label="标题" prop="emEcTitle">
        <el-input v-model="queryParams.emEcTitle" placeholder="请输入标题" />
      </el-form-item>
      <el-form-item label="内容" prop="emEcContent">
        <el-input v-model="queryParams.emEcContent" placeholder="请输入内容" />
      </el-form-item>
      ...
      <el-form-item label="实施部门" prop="emEcImpDept">
        <el-select clearable v-model="queryParams.emEcImpDept" placeholder="请选择实施部门">
        ...
        <el-row :gutter="20">
          ...
          <!-- <el-col :lg="12">
            <el-form-item label="ID" prop="emId">
              <el-input-number v-model.number="form.emId" controls-position="right" :placeholder="$t('btn.enter')+'ID'" :disabled="title==$t('btn.edit')"/>
            </el-form-item>
          </el-col> -->
          ...
          <el-col :lg="6">
            <el-form-item label="发行日" prop="emEcIssueDate">
              <el-date-picker v-model="form.emEcIssueDate" type="datetime" :teleported="false"
          ...
          <el-col :lg="6">
            <el-form-item label="设变No." prop="emEcNo">
              <el-input v-model="form.emEcNo" :placeholder="$t('btn.enter')+'设变No.'" />
            </el-form-item>
          </el-col>

          <el-col :lg="6">
            <el-form-item label="担当" prop="emEcAssigned">
              <el-select v-model="form.emEcAssigned" :placeholder="$t('btn.select')+'担当'">
                <el-option v-for="item in  options.sql_ec_group " :key="item.dictValue" :label="item.dictLabel"
          ...
          <el-col :lg="6">
            <el-form-item label="损失金额" prop="emEcLossAmount">
              <el-input-number v-model.number="form.emEcLossAmount" :controls="true" controls-position="right"
          ...
          <el-col :lg="6">
            <el-form-item label="管理区分" prop="emEcManageCategory">
              <el-select v-model="form.emEcManageCategory" :placeholder="$t('btn.select')+'管理区分'">
                <el-option v-for="item in  options.sys_ec_mgtype " :key="item.dictValue" :label="item.dictLabel"
          ...
          <el-col :lg="6">
            <el-form-item label="实施部门" prop="emEcImpDept">
              <el-select v-model="form.emEcImpDept" :placeholder="$t('btn.select')+'实施部门'">
                <el-option v-for="item in  options.sql_dept_list " :key="item.dictValue" :label="item.dictLabel"
                  :value="item.dictValue"></el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :lg="6">
            <el-form-item label="输入日" prop="emEcEntryDate">
              <el-date-picker v-model="form.emEcEntryDate" type="datetime" :teleported="false"
                :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="24">
            <el-form-item label="标题" prop="emEcTitle">
              <el-input v-model="form.emEcTitle" :placeholder="$t('btn.enter')+'标题'" />
            </el-form-item>
          </el-col>
          <el-col :lg="24">
            <el-form-item label="状态" prop="emEcStatus">
          ...
          <el-col :lg="24">
            <el-form-item label="关联文件" prop="emEcDoc">
              <el-upload accept=".pdf,image/jpg,image/jpeg,image/png" :action="xxxxxxxxx"
                :before-upload="handleBeforeUpload" class="upload-demo" :limit="1" :on-change="handleChange"
                :on-exceed="handleExceed" :on-preview="handlePreview">
                <el-input v-model="form.emEcDoc" :placeholder="$t('btn.enter')+'关联文件'" />
                <el-button type="primary">关联文件上传</el-button>
                <template #tip>
          ...
          <el-col :lg="24">
            <el-form-item label="内容" prop="emEcContent">
              <el-input type="textarea" v-model="form.emEcContent" :placeholder="$t('btn.enter')+'内容'" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="联络No." prop="emEcLiaisonNo">
              <el-input v-model="form.emEcLiaisonNo" :placeholder="$t('btn.enter')+'联络No.'">
                <template #prepend>DTS-</template>
                <!--传递插槽-->
          ...
          <el-col :lg="12">
            <el-form-item label="联络文件" prop="emEcLiaisonDoc">
              <el-upload accept=".pdf,image/jpg,image/jpeg,image/png" :action="xxxxxxxxx"
                :before-upload="handleBeforeUpload" class="upload-demo" :limit="1" :on-change="handleChange"
                :on-exceed="handleExceed" :on-preview="handlePreview">
                <el-input v-model="form.emEcLiaisonDoc" :placeholder="$t('btn.enter')+'联络文件'" />
                <el-button type="primary">联络文件上传</el-button>
                <template #tip>
                  <div class="el-upload__tip">
                    只能上传一个图片或pdf格式的文件
                  </div>
          ...
          <el-col :lg="12">
            <el-form-item label="EppNo." prop="emEcEppLiaisonNo">
              <el-input v-model="form.emEcEppLiaisonNo" :placeholder="$t('btn.enter')+'EppNo.'">
          ...
          <el-col :lg="12">
            <el-form-item label="Epp文件" prop="emEcEppLiaisonDoc">
              ...
              <el-upload accept=".pdf,image/jpg,image/jpeg,image/png" :action="xxxxxxxxx"
                :before-upload="handleBeforeUpload" class="upload-demo" :limit="1" :on-change="handleChange"
                :on-exceed="handleExceed" :on-preview="handlePreview">
                <el-input v-model="form.emEcEppLiaisonDoc" :placeholder="$t('btn.enter')+'Epp文件'" />
                <el-button type="primary">Epp文件上传</el-button>
                <template #tip>
                  <div class="el-upload__tip">
                    只能上传一个图片或pdf格式的文件
                  </div>
          ...
          <el-col :lg="12">
            <el-form-item label="FppNo." prop="emEcFppLiaisonNo">
              <el-input v-model="form.emEcFppLiaisonNo" :placeholder="$t('btn.enter')+'FppNo.'">
          ...
          <el-col :lg="12">
            ...
            <el-form-item label="Fpp文件" prop="emEcFppLiaisonDoc">
              <el-upload accept=".pdf,image/jpg,image/jpeg,image/png" :action="xxxxxxxxx"
                :before-upload="handleBeforeUpload" class="upload-demo" :limit="1" :on-change="handleChange"
                :on-exceed="handleExceed" :on-preview="handlePreview">
                <el-input v-model="form.emEcFppLiaisonDoc" :placeholder="$t('btn.enter')+'Fpp文件'" />
                <el-button type="primary">Fpp文件上传</el-button>
                <template #tip>
                  <div class="el-upload__tip">
                    只能上传一个图片或pdf格式的文件
                  </div>
          ...
          <el-col :lg="12">
            <el-form-item label="外部No." prop="emEcExternalNo">
              <el-input v-model="form.emEcExternalNo" :placeholder="$t('btn.enter')+'外部No.'">
                <template #prepend>Http://</template></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            ...
            <el-form-item label="外部文件" prop="emEcExternalDoc">
              ...
              <el-upload accept=".pdf,image/jpg,image/jpeg,image/png" :action="xxxxxxxxx"
                :before-upload="handleBeforeUpload" class="upload-demo" :limit="1" :on-change="handleChange"
                :on-exceed="handleExceed" :on-preview="handlePreview">
                <el-input v-model="form.emEcExternalDoc" :placeholder="$t('btn.enter')+'外部文件'">
                </el-input>
                <el-button type="primary">外部文件上传</el-button>
                <template #tip>
                  <div class="el-upload__tip">
                    只能上传一个图片或pdf格式的文件,最大支持10Mb。
                  </div>
                </template>
                <el-button v-if="form.fileUrl" type="primary">
                  <a class="file-upload-link" :href="form.fileUrl" target="_blank">预览</a>
...
<script setup name="ppecmaster">
  ...
  function handleExport() {
    proxy
      .$confirm(proxy.$t('common.confirmExport') + "主设变信息表", proxy.$t('common.warningTips'), {
