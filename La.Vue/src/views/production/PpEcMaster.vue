  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      ...
      <el-form-item label="标题" prop="emEcTitle">
        <el-input clearable v-model="queryParams.emEcTitle" :placeholder="$t('btn.enter')+'标题'" />
      </el-form-item>
      ...
      <el-form-item label="输入日">
        <el-date-picker v-model="dateRangeEmEcEntryDate" type="datetimerange" range-separator="-"
          :start-placeholder="$t('btn.dateStart')" :end-placeholder="$t('btn.dateEnd')"
          :placeholder="$t('btn.select')+'输入日'" value-format="YYYY-MM-DD HH:mm:ss" :default-time="defaultTime"
          :shortcuts="dateOptions">
        </el-date-picker>
      </el-form-item>
      <el-form-item>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" :disabled="single" v-hasPermi="['pp:ecmaster:edit']" plain icon="edit"
          @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" :disabled="multiple" v-hasPermi="['pp:ecmaster:delete']" plain icon="delete"
          @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button color="#666699" v-hasPermi="['pp:ecmaster:delete']" plain icon="BrushFilled" @click="handleClear">
          {{ $t('btn.clean') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button color="#FF69B4" plain icon="download" @click="handleExport" v-hasPermi="['pp:ecmaster:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange"
      ...
      <el-table-column prop="emEcImpDept" label="输入部门" align="center" :show-overflow-tooltip="true"
            ...
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="关联文件" prop="emEcDoc">
                  <UploadFile clearable v-model="form.emEcDoc" :fileType="['pdf']" :fileSize="10"
                    :data="{ uploadType: 1 }" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="损失金额" prop="emEcLossAmount">
                  <el-input clearable v-model="form.emEcLossAmount" :placeholder="$t('btn.enter')+'损失金额'" />
                </el-form-item>
              </el-col>

              <el-col :lg="24">
                <el-form-item label="管理区分" prop="emEcManageCategory">
                  <el-select v-model="form.emEcManageCategory" filterable clearable
                    :placeholder="$t('btn.select')+'管理区分'">
                    <el-option v-for="item in  options.sys_ec_mgtype " :key="item.dictValue" :label="item.dictLabel"
            ...
            <el-row :gutter="20">
              ...
              <el-col :lg="12">
                <el-form-item label="联络文件" prop="emEcLiaisonDoc">
                  <UploadFile clearable v-model="form.emEcLiaisonDoc" :fileType="['pdf']" :fileSize="10"
                    :data="{ uploadType: 1 }" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="Epp文件" prop="emEcEppLiaisonDoc">
                  <UploadFile clearable v-model="form.emEcEppLiaisonDoc" :fileType="['pdf']" :fileSize="10"
                    :data="{ uploadType: 1 }" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="Fpp文件" prop="emEcFppLiaisonDoc">
                  <UploadFile clearable v-model="form.emEcFppLiaisonDoc" :fileType="['pdf']" :fileSize="10"
                    :data="{ uploadType: 1 }" />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="外部文件" prop="emEcExternalDoc">
                  <UploadFile clearable v-model="form.emEcExternalDoc" :fileType="['pdf']" :fileSize="10"
                    :data="{ uploadType: 1 }" />
                </el-form-item>
              </el-col>
            </el-row>
            ...
            <el-row :gutter="20">
              <el-col :lg="12">
                <el-form-item label="UDF01" prop="uDF01">
                  <el-input clearable v-model="form.uDF01" :placeholder="$t('btn.enter')+'UDF01'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF02" prop="uDF02">
                  <el-input clearable v-model="form.uDF02" :placeholder="$t('btn.enter')+'UDF02'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF03" prop="uDF03">
                  <el-input clearable v-model="form.uDF03" :placeholder="$t('btn.enter')+'UDF03'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF04" prop="uDF04">
                  <el-input clearable v-model="form.uDF04" :placeholder="$t('btn.enter')+'UDF04'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF05" prop="uDF05">
                  <el-input clearable v-model="form.uDF05" :placeholder="$t('btn.enter')+'UDF05'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF06" prop="uDF06">
                  <el-input clearable v-model="form.uDF06" :placeholder="$t('btn.enter')+'UDF06'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF51" prop="uDF51">
                  <el-input clearable v-model="form.uDF51" :placeholder="$t('btn.enter')+'UDF51'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF52" prop="uDF52">
                  <el-input clearable v-model="form.uDF52" :placeholder="$t('btn.enter')+'UDF52'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF53" prop="uDF53">
                  <el-input clearable v-model="form.uDF53" :placeholder="$t('btn.enter')+'UDF53'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF54" prop="uDF54">
                  <el-input clearable v-model="form.uDF54" :placeholder="$t('btn.enter')+'UDF54'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF55" prop="uDF55">
                  <el-input clearable v-model="form.uDF55" :placeholder="$t('btn.enter')+'UDF55'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UDF56" prop="uDF56">
                  <el-input clearable v-model="form.uDF56" :placeholder="$t('btn.enter')+'UDF56'" disabled />
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="软删除" prop="isDeleted">
                  <el-radio-group v-model="form.isDeleted">
                    <el-radio v-for="item in  options.isDeletedOptions" :key="item.dictValue" disabled
                      :label="item.dictValue">{{item.dictLabel}}</el-radio>
                  </el-radio-group>
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="CreateBy" prop="createBy">
                  <el-input clearable v-model="form.createBy" :placeholder="$t('btn.enter')+'CreateBy'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="CreateTime" prop="createTime">
                  <el-date-picker clearable v-model="form.createTime" type="datetime" :teleported="false" disabled
                    :placeholder="$t('btn.dateselect')"></el-date-picker>
                </el-form-item>
              </el-col>
              ...
              <el-col :lg="12">
                <el-form-item label="UpdateBy" prop="updateBy">
                  <el-input clearable v-model="form.updateBy" :placeholder="$t('btn.enter')+'UpdateBy'" disabled />
                </el-form-item>
              </el-col>

              <el-col :lg="12">
                <el-form-item label="UpdateTime" prop="updateTime">
                  <el-date-picker clearable v-model="form.updateTime" type="datetime" :teleported="false" disabled
                    :placeholder="$t('btn.dateselect')"></el-date-picker>
                </el-form-item>
              </el-col>
            </el-row>
              ...
              <el-col :lg="12">
                <el-form-item label="ID" prop="emId">
                  <el-input-number clearable v-model.number="form.emId" controls-position="right"
                    :placeholder="$t('btn.enter')+'ID'" :disabled="title==$t('btn.edit')||title==$t('btn.add')" />
                </el-form-item>
              </el-col>
            </el-row>
          </el-tab-pane>
