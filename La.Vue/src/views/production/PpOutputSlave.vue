  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      <el-form-item label="父GUID" prop="pomGuid">
        <el-input clearable v-model="queryParams.pomGuid" :placeholder="$t('btn.enter')+'父GUID'" />
      </el-form-item>
      <el-form-item>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="ID" prop="posId">
              <el-input-number clearable v-model.number="form.posId" controls-position="right" :placeholder="$t('btn.enter')+'ID'" :disabled="title==$t('btn.edit')"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="父GUID" prop="pomGuid">
              <el-input clearable v-model="form.pomGuid" :placeholder="$t('btn.enter')+'父GUID'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="生产时段" prop="posStartEndTime">
              <el-select v-model="form.posStartEndTime" filterable clearable  :placeholder="$t('btn.select')+'生产时段'">
          ...
          <el-col :lg="12">
            <el-form-item label="实际产能" prop="posRealOutput">
              <el-input clearable v-model="form.posRealOutput" :placeholder="$t('btn.enter')+'实际产能'" />
            </el-form-item>
          </el-col>
    
          <el-col :lg="12">
            <el-form-item label="停线时间" prop="posLineStopTime">
              <el-input clearable v-model="form.posLineStopTime" :placeholder="$t('btn.enter')+'停线时间'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="停线原因" prop="posStopCause">
              <el-select v-model="form.posStopCause" filterable clearable  :placeholder="$t('btn.select')+'停线原因'">
          ...
          <el-col :lg="12">
            <el-form-item label="停线说明" prop="posStopMemo">
              <el-input clearable v-model="form.posStopMemo" :placeholder="$t('btn.enter')+'停线说明'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="未达成原因" prop="posBadCause">
              <el-select v-model="form.posBadCause" filterable clearable  :placeholder="$t('btn.select')+'未达成原因'">
          ...
          <el-col :lg="12">
            <el-form-item label="未达成说明" prop="posBadMemo">
              <el-input clearable v-model="form.posBadMemo" :placeholder="$t('btn.enter')+'未达成说明'" />
            </el-form-item>
          </el-col>
    
          <el-col :lg="12">
            <el-form-item label="实际工数" prop="posRealTime">
              <el-input clearable v-model="form.posRealTime" :placeholder="$t('btn.enter')+'实际工数'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="实际工时" prop="posRealWork">
              <el-input clearable v-model="form.posRealWork" :placeholder="$t('btn.enter')+'实际工时'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="工时差异" prop="posRealWorkDiff">
              <el-input clearable v-model="form.posRealWorkDiff" :placeholder="$t('btn.enter')+'工时差异'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="产能差异" prop="posRealOutputDiff">
              <el-input clearable v-model="form.posRealOutputDiff" :placeholder="$t('btn.enter')+'产能差异'" />
            </el-form-item>
          </el-col>
    
          <el-col :lg="12">
            <el-form-item label="达成率" prop="posAchRatio">
              <el-input clearable v-model="form.posAchRatio" :placeholder="$t('btn.enter')+'达成率'" />
            </el-form-item>
          </el-col>
