        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="关联文件" prop="emEcDoc">
              <UploadFile ref="uploadRef" v-model="form.emEcDoc" :fileType="['pdf']" :fileSize="10" :drag="false"
                list-type="picture-card" :limit="1" :data="uploadData" :autoUpload="false"
                @success="handleUploadSuccess">
              </UploadFile>

              <el-button type="primary" @click="submitUpload">{{ $t('btn.submit') }}</el-button>
              <el-input clearable v-model="form.emEcDoc" :placeholder="$t('btn.enter')+'联络文件'" disabled />
            </el-form-item>
          ...
          <el-col :lg="24">
            <el-form-item label="联络文件" prop="emEcLiaisonDoc">
              <UploadFile ref="uploadRef" v-model="form.emEcLiaisonDoc" :fileType="['pdf']" :fileSize="10" :drag="false"
                list-type="picture-card" :limit="1" :data="uploadData" :autoUpload="false"
                @success="handleUploadSuccess">
              </UploadFile>
...
<script lang="ts" setup name="ppecmaster">
  // 引入 ppecmaster操作方法
  import {
