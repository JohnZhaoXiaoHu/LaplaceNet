...
<template>
  <div>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="success" :disabled="single" v-hasPermi="['pp:mfgorder:edit']" plain icon="edit"
          @click="handleUpdate">
          {{ $t('btn.edit') }}
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button type="danger" :disabled="multiple" v-hasPermi="['pp:mfgorder:delete']" plain icon="delete"
          @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange"
      @selection-change="handleSelectionChange" :summary-method="getSummaries" show-summary height="602"
      style="width: 100%">
      ...
      <el-table-column prop="moOrderItem" label="物料" align="center" :show-overflow-tooltip="true"
        v-if="columns.showColumn('moOrderItem')" />
      ...
      <el-table-column prop="moOrderDate" label="订单日期" align="center" :show-overflow-tooltip="true" sortable
      ...
      <el-table-column :label="$t('btn.operate')" align="center" width="160">
        <template #default="scope">
          <el-button v-hasPermi="['pp:mfgorder:edit']" type="success" icon="edit" :title="$t('btn.edit')"
            @click="handleUpdate(scope.row)"></el-button>
          <el-button v-hasPermi="['pp:mfgorder:delete']" type="danger" icon="delete" :title="$t('btn.delete')"
        ...
        <el-row :gutter="20">
          ...
          <!-- <el-col :lg="12">
            <el-form-item label="ID" prop="moId">
              <el-input-number v-model.number="form.moId" controls-position="right" :placeholder="$t('btn.enter')+'ID'"
          ...
          <el-col :lg="12">
            <el-form-item label="生产工厂" prop="moPlant">
              <el-select v-model="form.moPlant" :placeholder="$t('btn.select')+'生产工厂'"
                :disabled="title==$t('btn.edit')">
                <el-option v-for="item in  options.sys_plant_list " :key="item.dictValue" :label="item.dictLabel"
          ...
          <el-col :lg="12">
            <el-form-item label="订单类型" prop="moOrderType">
              <el-select v-model="form.moOrderType" :placeholder="$t('btn.select')+'订单类型'"
                :disabled="title==$t('btn.edit')">
                <el-option v-for="item in  options.sys_mo_type " :key="item.dictValue" :label="item.dictLabel"
                  :value="item.dictValue"></el-option>
              </el-select>
          ...
          <el-col :lg="12">
            <el-form-item label="物料" prop="moOrderItem">
              <el-input v-model="form.moOrderItem" :placeholder="$t('btn.enter')+'物料'"
                :disabled="title==$t('btn.edit')" />
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="工单数量" prop="moOrderQty">
              <el-input v-model="form.moOrderQty" :placeholder="$t('btn.enter')+'工单数量'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="生产数量" prop="moOrderProQty">
              <el-input v-model="form.moOrderProQty" :placeholder="$t('btn.enter')+'生产数量'" />
            </el-form-item>
          </el-col>
...
<script setup name="ppmfgorder">
  // 引入 ppmfgorder操作方法
  import {
    listPpMfgOrder, addPpMfgOrder, delPpMfgOrder, updatePpMfgOrder, getPpMfgOrder,
  ...
  function getSummaries(param) {
    ...
    columns.forEach((column, index) => {
      ...
      if (column.label == "工单数量" || column.label == "生产数量") {
