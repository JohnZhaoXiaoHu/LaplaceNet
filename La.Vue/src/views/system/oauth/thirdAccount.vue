...
<template>
  <div>
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button type="danger" :disabled="multiple" v-hasPermi="['system:thirdaccount:delete']" plain icon="delete"
          @click="handleDelete">
          {{ $t('btn.delete') }}
        </el-button>
      </el-col>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange"
      ...
      <el-table-column label="操作" align="center" width="160">
        <template #default="scope">
          ...
          <el-button v-hasPermi="['system:thirdaccount:delete']" type="danger" icon="delete" title="删除"
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="24">
            <el-form-item label="账号类型" prop="accountType">
              <el-select v-model="form.accountType" placeholder="请选择账号类型">
                <el-option v-for="item in options.accountTypeOptions" :key="item.dictValue" :label="item.dictLabel"
          ...
          <el-col :lg="24">
            <el-form-item label="添加时间" prop="addTime">
              <el-date-picker v-model="form.addTime" type="datetime" :teleported="false"
