  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      <el-form-item label="工厂" prop="bcPlant">
        <el-select filterable clearable  v-model="queryParams.bcPlant" :placeholder="$t('btn.select')+'工厂'">
      ...
      <el-form-item label="期间" prop="bcFy">
        <el-select filterable clearable  v-model="queryParams.bcFy" :placeholder="$t('btn.select')+'期间'">
      ...
      <el-form-item label="年月" prop="bcYm">
        <el-select filterable clearable  v-model="queryParams.bcYm" :placeholder="$t('btn.select')+'年月'">
      ...
      <el-form-item label="成品物料" prop="bcBomItem">
        <el-select filterable clearable  v-model="queryParams.bcBomItem" :placeholder="$t('btn.select')+'成品物料'">
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange" @selection-change="handleSelectionChange" height="602"
      ...
      <el-table-column prop="bcBalancedate" label="核算日期" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('bcBalancedate')"/>
      <el-table-column prop="remark" label="备注" align="center" :show-overflow-tooltip="true" v-if="columns.showColumn('remark')"/>
      <el-table-column :label="$t('btn.operate')" align="center" width="160">
        <template #default="scope">
          <el-button v-hasPermi="['fico:bomcosting:edit']" type="success" icon="edit" :title="$t('btn.edit')" @click="handleUpdate(scope.row)"></el-button>
          <el-button v-hasPermi="['fico:bomcosting:delete']" type="danger" icon="delete" :title="$t('btn.delete')" @click="handleDelete(scope.row)"></el-button>
        </template>
      </el-table-column>
    </el-table>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="ID" prop="bcId">
              <el-input-number clearable v-model.number="form.bcId" controls-position="right" :placeholder="$t('btn.enter')+'ID'" :disabled="title==$t('btn.edit')"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="工厂" prop="bcPlant">
              <el-select v-model="form.bcPlant" filterable clearable  :placeholder="$t('btn.select')+'工厂'">
          ...
          <el-col :lg="12">
            <el-form-item label="期间" prop="bcFy">
              <el-select v-model="form.bcFy" filterable clearable  :placeholder="$t('btn.select')+'期间'">
          ...
          <el-col :lg="12">
            <el-form-item label="年月" prop="bcYm">
              <el-select v-model="form.bcYm" filterable clearable  :placeholder="$t('btn.select')+'年月'">
          ...
          <el-col :lg="12">
            <el-form-item label="成品物料" prop="bcBomItem">
              <el-select v-model="form.bcBomItem" filterable clearable  :placeholder="$t('btn.select')+'成品物料'">
          ...
          <el-col :lg="12">
            <el-form-item label="物料文本" prop="bcItemText">
              <el-input clearable v-model="form.bcItemText" :placeholder="$t('btn.enter')+'物料文本'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="成本" prop="bcBomCost">
              <el-input-number clearable v-model.number="form.bcBomCost" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'成本'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="币种" prop="bcCurrency">
              <el-select v-model="form.bcCurrency" filterable clearable  :placeholder="$t('btn.select')+'币种'">
          ...
          <el-col :lg="12">
            <el-form-item label="核算日期" prop="bcBalancedate">
              <el-date-picker clearable v-model="form.bcBalancedate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
...
import { listFicoBomCosting, addFicoBomCosting, delFicoBomCosting, updateFicoBomCosting, getFicoBomCosting, 
