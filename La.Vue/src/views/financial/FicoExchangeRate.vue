  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      <el-form-item label="生效日期">
        <el-date-picker v-model="dateRangeErEffDate" type="datetimerange" range-separator="-"
          :start-placeholder="$t('btn.dateStart')" :end-placeholder="$t('btn.dateEnd')" placeholder="请选择生效日期"
          value-format="YYYY-MM-DD HH:mm:ss" :default-time="defaultTime" :shortcuts="dateOptions">
        </el-date-picker>
      </el-form-item>
      <el-form-item label="Fm币别" prop="erfmCcy">
        <el-select clearable v-model="queryParams.erfmCcy" placeholder="请选择Fm币别">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button color="#FF69B4" plain icon="download" @click="handleExport"
          v-hasPermi="['fico:exchangerate:export']">
          {{ $t('btn.export') }}
        </el-button>
      </el-col>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange"
      ...
      <el-table-column :label="$t('btn.operate')" align="center" width="160">
        <template #default="scope">
          <el-button v-hasPermi="['fico:exchangerate:edit']" type="success" icon="edit" :title="$t('btn.edit')"
            @click="handleUpdate(scope.row)"></el-button>
          <el-button v-hasPermi="['fico:exchangerate:delete']" type="danger" icon="delete" :title="$t('btn.delete')"
        ...
        <el-row :gutter="20">
          ...
          <!-- <el-col :lg="12">
            <el-form-item label="ID" prop="erId">
              <el-input-number v-model.number="form.erId" controls-position="right" :placeholder="$t('btn.enter')+'ID'" :disabled="title==$t('btn.edit')"/>
            </el-form-item>
          </el-col> -->
          ...
          <el-col :lg="12">
            <el-form-item label="生效日期" prop="erEffDate">
              <el-date-picker v-model="form.erEffDate" type="datetime" :teleported="false"
          ...
          <el-col :lg="12">
            <el-form-item label="基数" prop="erStd">
              <el-input-number v-model.number="form.erStd" :controls="true" controls-position="right"
          ...
          <el-col :lg="12">
            <el-form-item label="Fm币别" prop="erfmCcy">
              <el-select v-model="form.erfmCcy" :placeholder="$t('btn.select')+'Fm币别'">
                <el-option v-for="item in  options.sys_ccy_type " :key="item.dictValue" :label="item.dictLabel"
          ...
          <el-col :lg="12">
            <el-form-item label="汇率" prop="erRate">
              <el-input-number v-model.number="form.erRate" :controls="true" controls-position="right"
          ...
          <el-col :lg="12">
            <el-form-item label="To币别" prop="ertoCcy">
              <el-select v-model="form.ertoCcy" :placeholder="$t('btn.select')+'To币别'">
                <el-option v-for="item in  options.sys_ccy_type " :key="item.dictValue" :label="item.dictLabel"
                  :value="item.dictValue"></el-option>
              </el-select>
            </el-form-item>
