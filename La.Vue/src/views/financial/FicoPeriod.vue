  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      <el-form-item label="年月" prop="fpYm">
        <el-select filterable clearable  v-model="queryParams.fpYm" :placeholder="$t('btn.select')+'年月'">
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange" @selection-change="handleSelectionChange" height="602"
      ...
      <el-table-column prop="fpYm" label="年月" align="center" v-if="columns.showColumn('fpYm')">
        <template #default="scope">
          <dict-tag :options=" options.sql_ym_list " :value="scope.row.fpYm" />
        </template>
      </el-table-column>
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="财年" prop="fpFy">
              <el-select v-model="form.fpFy" filterable clearable  :placeholder="$t('btn.select')+'财年'">
          ...
          <el-col :lg="12">
            <el-form-item label="年月" prop="fpYm">
              <el-select v-model="form.fpYm" filterable clearable  :placeholder="$t('btn.select')+'年月'">
