    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange"
      ...
      <el-table-column :label="$t('btn.operate')" align="center" width="160">
        <template #default="scope">
          <el-button v-hasPermi="['fico:prctr:edit']" type="success" icon="edit" :title="$t('btn.edit')"
            @click="handleUpdate(scope.row)"></el-button>
          <el-button v-hasPermi="['fico:prctr:delete']" type="danger" icon="delete" :title="$t('btn.delete')"
        ...
        <el-row :gutter="20">
          ...
          <!-- <el-col :lg="12">
            <el-form-item label="Id主键" prop="fpId">
              <el-input-number v-model.number="form.fpId" controls-position="right" :placeholder="$t('btn.enter')+'Id主键'" :disabled="title==$t('btn.edit')"/>
            </el-form-item>
          </el-col> -->
          ...
          <el-col :lg="12">
            <el-form-item label="工厂" prop="fpPlnt">
              <el-select v-model="form.fpPlnt" :placeholder="$t('btn.select')+'工厂'">
                <el-option v-for="item in  options.sys_plant_list " :key="item.dictValue" :label="item.dictLabel"
          ...
          <el-col :lg="12">
            <el-form-item label="代码" prop="fpCode">
              <el-input v-model="form.fpCode" :placeholder="$t('btn.enter')+'代码'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="名称" prop="fpName">
              <el-input v-model="form.fpName" :placeholder="$t('btn.enter')+'名称'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="类别" prop="fpType">
              <el-select v-model="form.fpType" :placeholder="$t('btn.select')+'类别'">
                <el-option v-for="item in  options.sys_fin_costtype " :key="item.dictValue" :label="item.dictLabel"
                  :value="item.dictValue"></el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :lg="12">
            <el-form-item label="remark" prop="remark">
              <el-input v-model="form.remark" :placeholder="$t('btn.enter')+'remark'"  :disabled="true"/>
            </el-form-item>
          </el-col>
