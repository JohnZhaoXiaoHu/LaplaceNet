        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="销售额" prop="fwSalesVolume">
              <el-input-number clearable v-model.number="form.fwSalesVolume" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'销售额'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="工作天数" prop="fwWorkingDays">
              <el-input-number clearable v-model.number="form.fwWorkingDays" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'工作天数'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="直接工资率" prop="fwDirectWageRate">
              <el-input-number clearable v-model.number="form.fwDirectWageRate" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'直接工资率'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="直接人数" prop="fwDirect">
              <el-input-number clearable v-model.number="form.fwDirect" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'直接人数'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="直接加班费" prop="fwDirectOverTime">
              <el-input-number clearable v-model.number="form.fwDirectOverTime" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'直接加班费'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="直接工资" prop="fwDirectWages">
              <el-input-number clearable v-model.number="form.fwDirectWages" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'直接工资'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="间接工资率" prop="fwInDirectWageRate">
              <el-input-number clearable v-model.number="form.fwInDirectWageRate" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'间接工资率'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="间接人数" prop="fwInDirect">
              <el-input-number clearable v-model.number="form.fwInDirect" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'间接人数'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="间接加班费" prop="fwInDirectOverTime">
              <el-input-number clearable v-model.number="form.fwInDirectOverTime" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'间接加班费'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="间接工资" prop="fwInDirectWages">
              <el-input-number clearable v-model.number="form.fwInDirectWages" :controls="true" controls-position="right" :placeholder="$t('btn.enter')+'间接工资'" />
            </el-form-item>
          </el-col>
