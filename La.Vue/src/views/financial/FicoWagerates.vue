  ...
  <div>
    ...
    <el-table :data="dataList" v-loading="loading" ref="table" border highlight-current-row @sort-change="sortChange"
      ...
      <el-table-column :label="$t('btn.operate')" align="center" width="160">
        <template #default="scope">
          <el-button v-hasPermi="['fico:wagerates:edit']" type="success" icon="edit" :title="$t('btn.edit')"
            @click="handleUpdate(scope.row)"></el-button>
          <el-button v-hasPermi="['fico:wagerates:delete']" type="danger" icon="delete" :title="$t('btn.delete')"
        ...
        <el-row :gutter="20">
          ...
          <!-- <el-col :lg="12">
            <el-form-item label="ID" prop="fwId">
              <el-input-number v-model.number="form.fwId" controls-position="right" :placeholder="$t('btn.enter')+'ID'"
          ...
          <el-col :lg="12">
            <el-form-item label="币种" prop="fwCcy">
              <el-select v-model="form.fwCcy" :placeholder="$t('btn.select')+'币种'">
          ...
          <el-col :lg="12">
            <el-form-item label="销售额" prop="fwSalesVolume">
              <el-input-number v-model.number="form.fwSalesVolume" :controls="true" controls-position="right"
                @input="CalculateStdOutput" :placeholder="$t('btn.enter')+'销售额'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="工作天数" prop="fwWorkingDays">
              <el-input-number v-model.number="form.fwWorkingDays" :controls="true" controls-position="right"
          ...
          <el-col :lg="12">
            <el-form-item label="直接工资率" prop="fwDirectWageRate">
              <el-input-number v-model.number="form.fwDirectWageRate" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'直接工资率'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="直接人数" prop="fwDirect">
              <el-input-number v-model.number="form.fwDirect" :controls="true" controls-position="right"
          ...
          <el-col :lg="12">
            <el-form-item label="直接加班费" prop="fwDirectOverTime">
              <el-input-number v-model.number="form.fwDirectOverTime" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'直接加班费'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="直接工资" prop="fwDirectWages">
              <el-input-number v-model.number="form.fwDirectWages" :controls="true" controls-position="right"
          ...
          <el-col :lg="12">
            <el-form-item label="间接工资率" prop="fwInDirectWageRate">
              <el-input-number v-model.number="form.fwInDirectWageRate" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'间接工资率'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="间接人数" prop="fwInDirect">
              <el-input-number v-model.number="form.fwInDirect" :controls="true" controls-position="right"
          ...
          <el-col :lg="12">
            <el-form-item label="间接加班费" prop="fwInDirectOverTime">
              <el-input-number v-model.number="form.fwInDirectOverTime" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'间接加班费'" />
            </el-form-item>
          </el-col>

          <el-col :lg="12">
            <el-form-item label="间接工资" prop="fwInDirectWages">
              <el-input-number v-model.number="form.fwInDirectWages" :controls="true" controls-position="right"
                :placeholder="$t('btn.enter')+'间接工资'" />
            </el-form-item>
          </el-col>
...
<script setup name="ficowagerates">
  ...
  function CalculateStdOutput(val) {
    ...
    if (form.value.fwSalesVolume != undefined && form.value.fwSalesVolume != null && form.value.fwSalesVolume != 0) {
      form.value.fwDirectWageRate = parseFloat((Number(form.value.fwDirectOverTime) + Number(form.value.fwDirectWages)) / Number(val)).toFixed(2)
    }
    else {
      form.value.fwDirectWageRate = 0
    }
    if (form.value.fwSalesVolume != undefined && form.value.fwSalesVolume != null && form.value.fwSalesVolume != 0) {
      form.value.fwInDirectWageRate = parseFloat((Number(form.value.fwInDirectOverTime) + Number(form.value.fwInDirectWages)) / Number(val)).toFixed(2)
    }
    else {
