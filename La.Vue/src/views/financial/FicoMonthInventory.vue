  ...
  <div>
    <el-form :model="queryParams" label-position="right" inline ref="queryRef" v-show="showSearch" @submit.prevent>
      ...
      <el-form-item label="期间" prop="miFy">
        <el-select filterable clearable  v-model="queryParams.miFy" :placeholder="$t('btn.select')+'期间'">
      ...
      <el-form-item label="评估类" prop="miValType">
        <el-select filterable clearable  v-model="queryParams.miValType" :placeholder="$t('btn.select')+'评估类'">
      ...
      <el-form-item label="币种" prop="miLocalCcy">
        <el-select filterable clearable  v-model="queryParams.miLocalCcy" :placeholder="$t('btn.select')+'币种'">
        ...
        <el-row :gutter="20">
          ...
          <el-col :lg="12">
            <el-form-item label="ID" prop="miId">
              <el-input clearable v-model="form.miId" controls-position="right" :placeholder="$t('btn.enter')+'ID'" :disabled="title==$t('btn.edit')"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :lg="12">
            <el-form-item label="币种" prop="miLocalCcy">
              <el-select v-model="form.miLocalCcy" filterable clearable  :placeholder="$t('btn.select')+'币种'">
          ...
          <el-col :lg="12">
            <el-form-item label="登录日期" prop="miBalancedate">
              <el-date-picker clearable v-model="form.miBalancedate" type="datetime" :teleported="false" :placeholder="$t('btn.dateselect')"></el-date-picker>
            </el-form-item>
          </el-col>
