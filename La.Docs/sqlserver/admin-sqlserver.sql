...
CREATE TABLE sys_tasks_log  (
  ...
  status int NULL DEFAULT '0' ,		-- '执行状态（0正常 1失败）',
...
CREATE TABLE sys_dept  (
  ...
  IsDeleted int  NULL DEFAULT 0 ,					-- '删除标志（0代表存在 2代表删除）',
...
CREATE TABLE sys_dict_type  (
  ...
  status int  NULL DEFAULT '0'    ,-- '状态（0正常 1停用）',
...
CREATE TABLE sys_logininfor  (
  ...
  status int  NULL DEFAULT '0' ,-- '登录状态（0成功 1失败）',
...
CREATE TABLE sys_menu  (
  ...
  status int  NULL DEFAULT '0' ,-- '菜单状态（0正常 1停用）',
...
CREATE TABLE sys_post  (
  ...
  status int  NOT NULL DEFAULT 0, -- '状态（0正常 1停用）',
...
CREATE TABLE sys_role  (
  ...
  IsDeleted int  NOT NULL DEFAULT 0 , -- '删除标志（0代表存在 2代表删除）',
  create_by varchar(64)  NULL DEFAULT '' , -- '创建者',
  create_time datetime NULL DEFAULT NULL , -- '创建时间',
  update_by varchar(64)  NULL DEFAULT '' , -- '更新者',
  update_time datetime NULL DEFAULT NULL , -- '更新时间',
...
CREATE TABLE article  (
  ...
  status int null DEFAULT 0 ,  -- '文章状态1、已发布 2、草稿',
